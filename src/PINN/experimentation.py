...
E_mean, E_std, E_L= energy_vmc_and_plot(model_name, N=config.N, d=config.dim, samples=samples, beta=config.beta, a=config.a, omega_z=config.omega_z, omega_ho=config.omega_ho, full=full) # for evaluating the energy of the trained model
