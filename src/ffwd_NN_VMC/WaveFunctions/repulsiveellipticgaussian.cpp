...
double RepEllipticGaussian::evaluate(std::vector<std::unique_ptr<class Particle>>& particles) {
    double prod = 1;
    double dist = 0;
...
double RepEllipticGaussian::evaluateLn_noInteraction(std::vector<std::unique_ptr<class Particle>>& particles) {
    long double sum = 0;
...
double RepEllipticGaussian::evaluateLn(std::vector<std::unique_ptr<class Particle>>& particles) {
